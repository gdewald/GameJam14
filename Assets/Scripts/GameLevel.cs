...
public class GameLevel : MonoBehaviour {
	...
	void Awake(){
		...
		lvl1.walls.Add(wallL);
		lvl1.walls.Add(wallR);
		lvl1.walls.Add(wallT);
		lvl1.walls.Add(wallB);

		lvl1.spawns = new List<SmartGameObject>();
		lvl1.spawns.Add(spTL);
		lvl1.spawns.Add(spTR);
		lvl1.spawns.Add(spBL);
		...
		lvl2.walls.Add(wallL2);
		lvl2.walls.Add(wallR2);
		lvl2.walls.Add(wallT2);
		lvl2.walls.Add(wallB2);
		lvl2.walls.Add(leftEye);
		lvl2.walls.Add(rightEye);
		lvl2.walls.Add(mouth);
		lvl2.walls.Add(mouthL);
		lvl2.walls.Add(mouthR);

		lvl2.spawns = new List<SmartGameObject>();
		lvl2.spawns.Add(spTL2);
		lvl2.spawns.Add(spTR2);
		lvl2.spawns.Add(spBL2);
